...
namespace Lym.BaseRespository.SdtQueuesystem
{
    /// <summary>
    /// 仓储基类实现
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class BaseSdtQueuesystemRespository<T> : SdtQueuesystemContext<T>, IBaseRespository<T> where T : class, new()
    {
        #region 事务
