...
namespace Lym.BaseRespository
{
    /// <summary>
    /// 仓储基类接口
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public interface IBaseRespository<T> : ISimpleClient<T> where T : class, new()
    {

        SqlSugarClient GetInstance(DbType type, string connection);
